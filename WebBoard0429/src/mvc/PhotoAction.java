...
public class PhotoAction extends HttpServlet {  
	...
	protected void  user(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(value == null) 		{
			...
			out.println("<tr><td align=center width=150><img src='images/1.gif'> </td>");
			out.println("<td align=center width=150><img src='images/2.gif'> </td>");
			out.println("<td align=center width=150><img src='images/3.gif'> </td>");
			out.println("<td align=center width=150><img src='images/4.gif'> </td></tr>");
			
			out.println("<tr><td  align=center width=150><img src='images/5.gif'> </td>");
			out.println("<td width=150 align=center><img src='images/6.gif'> </td>");
			out.println("<td width=150 align=center><img src='images/7.gif'> </td>");
			out.println("<td width=150 align=center><img src='images/8.gif'> </td></tr>");
